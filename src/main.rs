...
fn load(gl_context: &glutin::Context<PossiblyCurrent>) -> Gl {
    let gl =
...
fn main() {
    ...
    //gl.draw_frame([0xFF as f32, 0xCC as f32, 0x00 as f32, 0xFF as f32]);

    unsafe {
        gl.gl.ClearColor(0xFF as f32, 0xFF as f32, 0x00 as f32, 0xFF as f32);
